...
function initialize(id) {
    ...
    var locations = [
        ...
        ['Collège des Bernardins', '20 Rue de Poissy, Paris, France']
...
{
    regexnom  = /^[A-Za-z àáâãäåçèéêëìíîïðòóôõöùúûüýÿ'-]{3,50}$/;
...
{
    var regextel = /^[ +(]{0,2}[0-9]{0,4}[)]?([-. ]?[0-9]{2,4}){3}[-. ]?[0-9]{0,3}[. ]?$/;
